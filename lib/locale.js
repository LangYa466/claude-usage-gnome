...
const STRINGS = {
    en: {
        // panel
        'panel.name': 'Claude Usage',
        // tooltips (hover)
        'tooltip.5h': 'Resets at {time} (in {rel})',
        'tooltip.7d': 'Resets in {rel}',
        // notifications — title
        ...
        'prefs.row.colo.subtitle':     'Expected Cloudflare colo, default SIN (Singapore)',
        'prefs.row.loc.title':         'loc',
        'prefs.row.loc.subtitle':      'Expected country code, default SG',
    ...
    'zh-CN': {
        'panel.name': 'Claude 用量',
        'tooltip.5h': '{time} 重置（还有 {rel}）',
        'tooltip.7d': '还有 {rel} 重置',
        ...
        'prefs.row.colo.title':        'colo',
        'prefs.row.colo.subtitle':     '期望的 Cloudflare 节点，默认 SIN（新加坡）',
        'prefs.row.loc.title':         'loc',
        'prefs.row.loc.subtitle':      '期望的国家代码，默认 SG',
        'prefs.group.token.title':     'Token',
